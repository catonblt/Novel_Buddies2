...
export const AGENTS: Record<AgentType, Agent> = {
  'story-architect': {
    ...
    color: '#8b5cf6',
    description:
      'Overall narrative structure, acts, chapters, scenes, and thematic architecture',
  },
  'character-specialist': {
    type: 'character-specialist',
    name: 'Character & Dialogue Specialist',
    icon: '👤',
    color: '#ec4899',
    description:
      'Character creation, psychology, development, and authentic dialogue',
  },
  'prose-writer': {
    type: 'prose-writer',
    name: 'Prose & Atmosphere Writer',
    icon: '✍️',
    color: '#06b6d4',
    description:
      'Scene writing with beautiful prose, sensory details, and atmospheric description',
  },
  'research-continuity': {
    type: 'research-continuity',
    name: 'Research & Continuity Guardian',
    icon: '📚',
    color: '#f59e0b',
    description:
      'Fact-checking, research, story bible maintenance, and continuity tracking',
  },
  'editorial-reviewer': {
    ...
    color: '#10b981',
    description:
      'Critical reading, feedback, redundancy detection, and pacing analysis',
  },
};
